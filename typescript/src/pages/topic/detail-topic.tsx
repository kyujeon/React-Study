...
function DetailTopic() {
  ...
  // 토픽 삭제
  // 작성자만 삭제 (작성한 user_id / supabase Topic 데이터 테이블에서는 author로 관리)
  ...
  return (
    <div className="w-full max-w-[1328px] min-h-[720px] flex-1 flex flex-col pb-6">
      {/* 제목, 카테고리, 썸네일, 버튼박스 영역 */}
      <div
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      해당 토픽의 모든 내용이 영구적으로 삭제되어 복구할 수
                      없습니다.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction
                      className="bg-red-900/50 text-white border hover:bg-red-800/50 cursor-pointer"
